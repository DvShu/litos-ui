import{$ as u}from"./chunks/dom.DNZbcrqS.js";import{v as p,P as h,C as c,c as b,o as m,ag as i,G as l,j as e,w as n,a}from"./chunks/framework.DaU-16c2.js";const _=JSON.parse('{"title":"Input 输入框","description":"","frontmatter":{},"headers":[],"relativePath":"components/input.md","filePath":"components/input.md","lastUpdated":1744789039000}'),f={name:"components/input.md"},v=Object.assign(f,{setup(g){let r;function s(o){let t=parseInt(o,10);return Number.isNaN(t)?t="":t=Math.abs(t),String(t)}return p(()=>{h(()=>{r=u("#input"),r.addEventListener("change",function(o){console.log("input",o.target.value)}),r.setParser(s)})}),(o,t)=>{const d=c("ClientOnly");return m(),b("div",null,[t[6]||(t[6]=i("",6)),l(d,null,{default:n(()=>t[0]||(t[0]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-input placeholder="请输入内容"></l-input>
`)],-1)])),_:1,__:[0]}),t[7]||(t[7]=e("h3",{id:"禁用状态",tabindex:"-1"},[a("禁用状态 "),e("a",{class:"header-anchor",href:"#禁用状态","aria-label":'Permalink to "禁用状态"'},"​")],-1)),t[8]||(t[8]=e("p",null,[a("通过 "),e("code",null,"disabled"),a(" 属性设置输入框为禁用状态。")],-1)),l(d,null,{default:n(()=>t[1]||(t[1]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-input placeholder="请输入内容" disabled></l-input>
`)],-1)])),_:1,__:[1]}),t[9]||(t[9]=i("",2)),l(d,null,{default:n(()=>t[2]||(t[2]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-input placeholder="只能输入正整数" allow-input="integer"></l-input>
  <l-input placeholder="只能输入整数" allow-input="-integer"></l-input>
  <l-input placeholder="输入数字,保留2位小数" allow-input="-number.2"></l-input>
`)],-1)])),_:1,__:[2]}),t[10]||(t[10]=e("h3",{id:"输入解析",tabindex:"-1"},[a("输入解析 "),e("a",{class:"header-anchor",href:"#输入解析","aria-label":'Permalink to "输入解析"'},"​")],-1)),t[11]||(t[11]=e("p",null,[a("通过 "),e("code",null,"setParser"),a(" 给节点设置自定义 "),e("code",null,"parser"),a(" 在接受到输入值的时候进行解析，例如：只允许输入正整数")],-1)),l(d,null,{default:n(()=>t[3]||(t[3]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-input id="input" placeholder="请输入正整数" clearable></l-input>
