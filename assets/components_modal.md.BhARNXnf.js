import{c as A,o as h,$ as w,b as E,i as b,a as M}from"./chunks/dom.C80Rjh4g.js";import{B as k,M as x,C as v,F as C,I as q}from"./chunks/index.ArPyUolZ.js";import{r as y,I as B}from"./chunks/info.Dcmrf-ai.js";import{v as P,P as T,x as L,C as S,o as I,c as _,ag as f,E as p,w as m,j as t,a as d}from"./chunks/framework.CwRcgf5g.js";import"./chunks/color.DEra9DJZ.js";import"./chunks/index.EbPK5eBu.js";function $(c,l,a,r="alert"){return new Promise(i=>{const s=[];if(a.icon){let e=a.icon();e.setAttribute("slot","header"),s.push(e.outerHTML)}s.push(`<span slot="header">${c}</span>`),r==="prompt"?(s.push(`<l-form-item label="${l}" label-position="top" inner-block>`),s.push(`<l-input placeholder="${a.placeholder||""}"></l-input>`),s.push("</l-form-item>")):s.push(`<span>${l}</span>`);let o=A("l-modal",{cancel:`${a.showCancel}`,innerHTML:s.join(""),show:!0,class:`l-modal-box l-modal-box--${r}`,close:`${a.close}`,"mask-closable":`${a.maskClosable}`});h(o,"close",()=>{o.remove(),o=void 0},{once:!0}),h(o,"ok",()=>{let e=!0;r==="prompt"&&(e=w(".l-modal-box l-input").value),o.removeAttribute("show"),i(e)},{once:!0}),h(o,"cancel",()=>{o.removeAttribute("show"),i(!1)},{once:!0}),document.body.appendChild(o)})}function F(c,l,a){return y([k,x,v]),new Promise(r=>{const i={showCancel:!1,close:0,maskClosable:!1,icon:void 0,...a};return $(l||"提示",c,i,"alert")})}function V(c,l,a){y([k,x,v,B]);const r={showCancel:!0,close:0,maskClosable:!0,icon:()=>A("l-info-icon",{style:"color:#1890ff;"}),...a};return $(l||"提示",c,r,"confirm")}function j(c,l,a){y([k,x,v,B,C,q]);const r={showCancel:!0,close:0,maskClosable:!0,placeholder:"",...a};return $(l||"提示",c,r,"prompt")}const g={alert:F,confirm:V,prompt:j},J=JSON.parse('{"title":"Modal 对话框","description":"","frontmatter":{},"headers":[],"relativePath":"components/modal.md","filePath":"components/modal.md","lastUpdated":1773031557000}'),D={name:"components/modal.md"},G=Object.assign(D,{setup(c){let l,a;function r(o){const n=o.target.id;n==="alert"?g.alert("这是一段内容","标题").then(()=>{console.log("alert close")}):n==="confirm"?g.confirm("确定要保存更改？","提示").then(u=>{console.log(u)}):n==="prompt"?g.prompt("指令","指令密钥",{placeholder:"请输入指令"}).then(u=>{console.log(u)}):w(`l-modal[for="${n}"]`).setAttribute("show","true")}function i(o){o.target.removeAttribute("show")}function s(o){const e=o.target;e.getAttribute("for")==="open3"&&(e.setAttribute("confirm-loading","true"),e.innerHTML="<span>正在提交内容……</span>",setTimeout(()=>{e.innerHTML="<span>对话框内容</span>",e.removeAttribute("confirm-loading"),o.target.removeAttribute("show")},1500))}return P(()=>{T(()=>{l=E("l-button[id]"),a=E("l-modal"),b(l,o=>{h(o,"click",r)}),b(a,o=>{h(o,"cancel",i),h(o,"ok",s)})})}),L(()=>{l&&(b(l,o=>{M(o,"click",r)}),l=void 0),a&&(b(a,o=>{M(o,"cancel",i)}),a=void 0)}),(o,e)=>{const n=S("ClientOnly");return I(),_("div",null,[e[6]||(e[6]=f(`<h1 id="modal-对话框" tabindex="-1">Modal 对话框 <a class="header-anchor" href="#modal-对话框" aria-label="Permalink to &quot;Modal 对话框&quot;">​</a></h1><p>在保留当前页面状态的情况下，弹出一个对话框告知用户并承载相关操作，包含：标题区、内容区、操作区</p><h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Modal, regist, Button, CloseIcon } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;litos-ui&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
`)])],-1)])]),_:1}),e[12]||(e[12]=t("h3",{id:"关闭按钮",tabindex:"-1"},[d("关闭按钮 "),t("a",{class:"header-anchor",href:"#关闭按钮","aria-label":'Permalink to "关闭按钮"'},"​")],-1)),e[13]||(e[13]=t("p",null,[d("通过设置 "),t("code",null,"close"),d(" 来控制关闭按钮的显示以及位置；"),t("code",null,"0"),d(" - 不显示, "),t("code",null,"1"),d(" - 显示在框内(默认), "),t("code",null,"2"),d(" - 显示在边角")],-1)),p(n,null,{default:m(()=>[...e[3]||(e[3]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-modal for="open4" header-title="Title" close="2">
    <span>对话框内容</span>
  </l-modal>
