import{i as d,o as u,b as r,a as k}from"./chunks/dom.BOKvBN-7.js";import{c as b}from"./chunks/index.DCtgrrjC.js";import{v as g,P as m,x as v,C as y,c as E,o as f,ag as p,G as e,j as i,w as l,a as n}from"./chunks/framework.BCyZWppQ.js";import"./chunks/index.DZ7iFm8i.js";const A=JSON.parse('{"title":"CSS Util","description":"","frontmatter":{},"headers":[],"relativePath":"css_util.md","filePath":"css_util.md","lastUpdated":1735551012000}'),_={name:"css_util.md"},S=Object.assign(_,{setup(C){const h=b();function c(t){const a=t.target.getAttribute("data-transition"),s=r(`[l-transition="${a}"]`);d(s,o=>{o.style.display==="none"?o.setAttribute("l-transition-emit","show"):o.setAttribute("l-transition-emit","hide")})}return g(()=>{m(()=>{h.init(),d(r("[data-transition]"),t=>{u(t,"click",c)})})}),v(()=>{h.destroy(),d(r("[data-transition]"),t=>{k(t,"click",c)})}),(t,a)=>{const s=y("ClientOnly");return f(),E("div",null,[a[5]||(a[5]=p("",10)),e(s,null,{default:l(()=>a[0]||(a[0]=[i("l-code-preview",null,[i("textarea",{lang:"html"},`  <l-button data-transition="l-opacity">Toggle</l-button>
