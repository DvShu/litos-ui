...
`)],-1)])]),_:1}),t[11]||(t[11]=l('<blockquote><p>也可以再构造 <code>Popover</code> 对象时传递 <code>placement</code> 参数来设置弹出位置。</p></blockquote><h3 id="不显示箭头" tabindex="-1">不显示箭头 <a class="header-anchor" href="#不显示箭头" aria-label="Permalink to &quot;不显示箭头&quot;">​</a></h3><p>构造 <code>Popover</code> 时将 <code>arrow</code> 参数设置为 <code>false</code> 即可；同时可以设置 <code>offset</code> 参数来设置偏移量。</p>',3)),d(n,null,{default:r(()=>[...t[3]||(t[3]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-button id="none-arrow" data-title="提示内容">提示</l-button>
...
`)])],-1)])]),_:1}),t[12]||(t[12]=e("h3",{id:"自定义内容",tabindex:"-1"},[a("自定义内容 "),e("a",{class:"header-anchor",href:"#自定义内容","aria-label":'Permalink to "自定义内容"'},"​")],-1)),t[13]||(t[13]=e("p",null,[a("通过 "),e("code",null,"slot"),a(" 插槽来设置 "),e("code",null,"l-popover"),a(" 的内容")],-1)),d(n,null,{default:r(()=>[...t[4]||(t[4]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-button id="custom">提示</l-button>
...
`)])],-1)])]),_:1}),t[14]||(t[14]=l(`<blockquote><p>出了通过这种形式外，也可以自己通过 <code>popover</code> 属性，指向一个 <code>popover</code> 节点，这个时候，可以完全自定义包括整个 <code>popover</code> 在内的结构</p></blockquote><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-QQ5kV" id="tab-NqDrzRq" checked><label data-title="html" for="tab-NqDrzRq">html</label><input type="radio" name="group-QQ5kV" id="tab-2nO_vw-"><label data-title="js" for="tab-2nO_vw-">js</label></div><div class="blocks"><div class="language-html vp-adaptive-theme active line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">div</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> id</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;popover&quot;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> class</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;l-popover&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
