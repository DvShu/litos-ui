...
`)])],-1)])]),_:1}),t[4]||(t[4]=s('<blockquote><p>注意: 设置 <code>l-transition-method=&quot;remove&quot;</code> 后，新添加节点时，需要手动调用 <code>trans.add()</code> 方法重新添加节点动画</p></blockquote><h3 id="手动动画" tabindex="-1">手动动画 <a class="header-anchor" href="#手动动画" aria-label="Permalink to &quot;手动动画&quot;">​</a></h3><p>如果想要手动控制动画，可以通过直接引用 <code>ph-utils/dom transition</code> 然后调用 <code>transition</code> 方法即可。</p>',3)),c(i,null,{default:p(()=>[...t[1]||(t[1]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-button id="toggle2">Toggle</l-button>
  <p id="text2">hello</p>
