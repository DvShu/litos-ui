import{$ as p}from"./chunks/dom.DBNJew1L.js";import{v as u,P as h,C as c,c as b,o as m,ag as i,G as l,j as e,w as n,a as d}from"./chunks/framework._HD6XqYi.js";const v=JSON.parse('{"title":"Input 输入框","description":"","frontmatter":{},"headers":[],"relativePath":"components/input.md","filePath":"components/input.md","lastUpdated":1763567357000}'),f={name:"components/input.md"},P=Object.assign(f,{setup(g){let r;function s(o){let t=parseInt(o,10);return Number.isNaN(t)?t="":t=Math.abs(t),String(t)}return u(()=>{h(()=>{r=p("#input"),r.addEventListener("change",function(o){console.log("input",o.target.value)}),r.setParser(s)})}),(o,t)=>{const a=c("ClientOnly");return m(),b("div",null,[t[6]||(t[6]=i("",6)),l(a,null,{default:n(()=>[...t[0]||(t[0]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-input placeholder="请输入内容"></l-input>
