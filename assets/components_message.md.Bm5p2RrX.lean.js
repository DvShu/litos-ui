import{e as m,i as p,o as b}from"./chunks/browser.9X2T-Mhz.js";import{M as h}from"./chunks/index.DXGLPKnO.js";import{v as k,P as f,x as _,C as y,o as M,c as x,a2 as n,E as i,w as r,j as t,a as s}from"./chunks/framework.0mmZ3Di7.js";import"./chunks/info.DQ2t9hrF.js";import"./chunks/index.B_dLCkhl.js";const C=JSON.parse('{"title":"Message 消息提示","description":"","frontmatter":{},"headers":[],"relativePath":"components/message.md","filePath":"components/message.md","lastUpdated":1787245584000}'),q={name:"components/message.md"},S=Object.assign(q,{setup(v){let d,l;function c(a){const e=a.target,o=e.getAttribute("data-message"),u=e.getAttribute("data-type")||"info",g=e.getAttribute("data-duration")||3e3;u!=="close"?l=h.show({message:o,type:u,duration:Number(g)}):h.close(l)}return k(()=>{f(()=>{d=m(".preview-container l-button"),p(d,a=>{b(a,"click",c)})})}),_(()=>{d&&p(d,a=>{a.removeEventListener("click",c)})}),(a,e)=>{const o=y("ClientOnly");return M(),x("div",null,[e[3]||(e[3]=n("",7)),i(o,null,{default:r(()=>[...e[0]||(e[0]=[t("l-code-preview",null,[t("textarea",null,`<l-button data-message="这是一条普通的提示信息">显示消息</l-button>
