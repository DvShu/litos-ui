import{$ as p}from"./chunks/dom.CgJDYxOB.js";import{v as u,P as h,C as c,c as b,o as m,ag as i,G as n,j as e,w as l,a}from"./chunks/framework.BCyZWppQ.js";const x=JSON.parse('{"title":"Input 输入框","description":"","frontmatter":{},"headers":[],"relativePath":"components/input.md","filePath":"components/input.md","lastUpdated":1737345140000}'),k={name:"components/input.md"},P=Object.assign(k,{setup(g){let r;function s(o){let t=parseInt(o,10);return Number.isNaN(t)?t="":t=Math.abs(t),String(t)}return u(()=>{h(()=>{r=p("#input"),r.setParser(s)})}),(o,t)=>{const d=c("ClientOnly");return m(),b("div",null,[t[4]||(t[4]=i("",6)),n(d,null,{default:l(()=>t[0]||(t[0]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-input placeholder="请输入内容"></l-input>
