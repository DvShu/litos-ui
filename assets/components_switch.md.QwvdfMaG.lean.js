import{$ as l}from"./chunks/browser.9X2T-Mhz.js";import{v as h,P as r,C as u,o as b,c as m,a2 as c,E as o,w as i,j as t,a}from"./chunks/framework.0mmZ3Di7.js";const g=JSON.parse('{"title":"Switch 开关","description":"","frontmatter":{},"headers":[],"relativePath":"components/switch.md","filePath":"components/switch.md","lastUpdated":1787245584000}'),p={name:"components/switch.md"},S=Object.assign(p,{setup(w){let d;return h(()=>{r(()=>{d=l("#custom-switch"),d!=null&&d.setActionRender(s=>s.checked?"<l-moon-icon></l-moon-icon>":document.createElement("l-sun-icon"))})}),(s,e)=>{const n=u("ClientOnly");return b(),m("div",null,[e[3]||(e[3]=c("",7)),o(n,null,{default:i(()=>[...e[0]||(e[0]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-switch></l-switch>
