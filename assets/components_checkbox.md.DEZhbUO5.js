import{$ as b,o as u,a as k}from"./chunks/browser.9X2T-Mhz.js";import{v as x,P as p,x as m,C as v,o as g,c as C,a2 as r,E as l,w as n,j as t,a as d}from"./chunks/framework.0mmZ3Di7.js";const y=JSON.parse('{"title":"Checkbox 复选框","description":"","frontmatter":{},"headers":[],"relativePath":"components/checkbox.md","filePath":"components/checkbox.md","lastUpdated":1787245584000}'),f={name:"components/checkbox.md"},P=Object.assign(f,{setup(q){let o,a;function i(h){const e=h.detail.value.length;e===4?(o.removeAttribute("indeterminate"),o.checked=!0):e===0?(o.removeAttribute("indeterminate"),o.checked=!1):(o.setAttribute("indeterminate",""),o.checked=!1)}function s(h){const e=h.detail.checked;o.removeAttribute("indeterminate"),e?a.value="CD&BJ&SZ&HZ":a.value=""}return x(()=>{p(()=>{a=b("#group"),o=b("#check-all"),u(a,"change",i),u(o,"change",s)})}),m(()=>{a&&k(a,"change",i),o&&k(o,"change",s)}),(h,e)=>{const c=v("ClientOnly");return g(),C("div",null,[e[5]||(e[5]=r(`<h1 id="checkbox-复选框" tabindex="-1">Checkbox 复选框 <a class="header-anchor" href="#checkbox-复选框" aria-label="Permalink to &quot;Checkbox 复选框&quot;">​</a></h1><p>在一组备选项中进行多选。适用提醒用户勾选场景，突出多选框选项，可以有效增加用户识别度。</p><h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Checkbox, regist } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;litos-ui&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">regist</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">([Checkbox]);</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>使用当只有一个选项时，可以直接 <code>checked</code> 绑定 <code>boolean</code> 值来控制是否选中；使用 <code>slot-label</code> 来重写选项的文字。</p>`,7)),l(c,null,{default:n(()=>[...e[0]||(e[0]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-checkbox checked>
    <span>
      <span>同意</span>
      <a href='#'>隐私协议</a>
    </span>
  </l-checkbox>
`)],-1)])]),_:1}),e[6]||(e[6]=t("h3",{id:"禁用状态",tabindex:"-1"},[d("禁用状态 "),t("a",{class:"header-anchor",href:"#禁用状态","aria-label":'Permalink to "禁用状态"'},"​")],-1)),e[7]||(e[7]=t("p",null,[d("使用 "),t("code",null,"disabled"),d(" 属性来禁用复选框。")],-1)),l(c,null,{default:n(()=>[...e[1]||(e[1]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-checkbox disabled checked>禁用</l-checkbox>
`)],-1)])]),_:1}),e[8]||(e[8]=t("h3",{id:"多选框组",tabindex:"-1"},[d("多选框组 "),t("a",{class:"header-anchor",href:"#多选框组","aria-label":'Permalink to "多选框组"'},"​")],-1)),e[9]||(e[9]=t("p",null,[d("结合 "),t("code",null,"l-checkbox-group"),d(" 组件实现单选框组")],-1)),l(c,null,{default:n(()=>[...e[2]||(e[2]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-checkbox-group value="CD&BJ" gap="15">
...
`)],-1)])]),_:1}),e[10]||(e[10]=r('<blockquote><p>注意：传递给 <code>l-checkbox-group</code> 的 <code>value</code> 为多选值的每一项 <code>encodeURIComponent</code> 后拼接 <code>&amp;</code></p></blockquote><h3 id="按钮样式" tabindex="-1">按钮样式 <a class="header-anchor" href="#按钮样式" aria-label="Permalink to &quot;按钮样式&quot;">​</a></h3><p>只需要为 <code>l-checkbox</code> 设置 <code>button</code> 属性，即可将复选框变为按钮样式</p>',3)),l(c,null,{default:n(()=>[...e[3]||(e[3]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-checkbox-group value="CD&BJ">
...
`)],-1)])]),_:1}),e[11]||(e[11]=t("h3",{id:"中间状态",tabindex:"-1"},[d("中间状态 "),t("a",{class:"header-anchor",href:"#中间状态","aria-label":'Permalink to "中间状态"'},"​")],-1)),e[12]||(e[12]=t("p",null,[d("设置 "),t("code",null,"indeterminate"),d(" 属性，表示不确定状态，一般用于实现部分选中的状态。")],-1)),l(c,null,{default:n(()=>[...e[4]||(e[4]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <div style="margin-bottom: 10px;">
...
`),t("textarea",{lang:"ts"},`  import { $one, on, off } from 'ph-utils/browser';
  //-
