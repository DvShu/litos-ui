import{o as r,$ as n,a as c,t as p}from"./chunks/dom.DwYf1ZNH.js";import{c as m}from"./chunks/index.8rW6KwGA.js";import{d as u,v as k,P as b,x as y,c as x,a2 as a,G as h,w as g,B as f,o as v,j as e}from"./chunks/framework.CmfdOiHF.js";import"./chunks/index.DZ7iFm8i.js";const F=JSON.parse('{"title":"Transition 过渡","description":"","frontmatter":{},"headers":[],"relativePath":"components/transition.md","filePath":"components/transition.md","lastUpdated":1737345140000}'),E={name:"components/transition.md"},C=u({...E,setup(q){let o;function s(){const i=n("#text1");(i.getAttribute("l-transition-emit")||"show")==="hide"?i.setAttribute("l-transition-emit","show"):i.setAttribute("l-transition-emit","hide")}function d(){const i=n("#text2");i.style.display==="none"?(i.style.display="block",p(i,[["opacity","0","0.3s"]])):p(i,[["opacity","0","0.3s"]],"leave",()=>{i.style.display="none"})}return k(()=>{b(()=>{o=m(),o.init(),c(n("#toggle1"),"click",s),c(n("#toggle2"),"click",d)})}),y(()=>{o.destroy(),r(n("#toggle1"),"click",s),r(n("#toggle2"),"click",d)}),(i,t)=>{const l=f("ClientOnly");return v(),x("div",null,[t[2]||(t[2]=a(`<h1 id="transition-过渡" tabindex="-1">Transition 过渡 <a class="header-anchor" href="#transition-过渡" aria-label="Permalink to &quot;Transition 过渡&quot;">​</a></h1><p>帮助你制作基于状态变化的过渡和动画；通常在一个元素或组件进入和离开 <code>DOM</code> 时应用动画</p><h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { createTransition } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;litos-ui&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
