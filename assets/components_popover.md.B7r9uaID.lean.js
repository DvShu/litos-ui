import{_ as a,C as p,c as i,o as s,ag as r,G as n,j as o,w as d,a as e}from"./chunks/framework.BCyZWppQ.js";const k=JSON.parse('{"title":"Popover 弹出气泡","description":"","frontmatter":{},"headers":[],"relativePath":"components/popover.md","filePath":"components/popover.md","lastUpdated":1737345140000}'),c={name:"components/popover.md"};function u(b,t,h,v,g,m){const l=p("ClientOnly");return s(),i("div",null,[t[6]||(t[6]=r("",7)),n(l,null,{default:d(()=>t[0]||(t[0]=[o("l-code-preview",null,[o("textarea",{lang:"html"},`  <l-popover content="悬浮提示" inline>
    <a slot="trigger">提示</a>
  </l-popover>
`)],-1)])),_:1}),t[7]||(t[7]=r("",2)),n(l,null,{default:d(()=>t[1]||(t[1]=[o("l-code-preview",null,[o("textarea",{lang:"html"},`  <l-popover content="悬浮提示" inline>
...
`)],-1)])),_:1}),t[14]||(t[14]=r("",3)),n(l,null,{default:d(()=>t[5]||(t[5]=[o("l-code-preview",null,[o("textarea",{lang:"html"},`  <l-popover content="提示内容" theme="tooltip" placement="top">
    <l-button slot="trigger">提示</l-button>
  </l-popover>
`),o("div",{class:"source"},[o("textarea",{lang:"html"},`  <l-button>按钮</l-button>
`)])],-1)])),_:1}),t[15]||(t[15]=r("",7))])}const P=a(c,[["render",u]]);export{k as __pageData,P as default};
