import{$ as l}from"./chunks/dom.BOKvBN-7.js";import{v as h,P as r,C as u,c as b,o as m,ag as c,G as o,j as t,w as i,a}from"./chunks/framework.BCyZWppQ.js";const g=JSON.parse('{"title":"Switch 开关","description":"","frontmatter":{},"headers":[],"relativePath":"components/switch.md","filePath":"components/switch.md","lastUpdated":1734017180000}'),p={name:"components/switch.md"},S=Object.assign(p,{setup(w){let d;return h(()=>{r(()=>{d=l("#custom-switch"),d!=null&&d.setActionRender(s=>s.checked?"<l-moon-icon></l-moon-icon>":document.createElement("l-sun-icon"))})}),(s,e)=>{const n=u("ClientOnly");return m(),b("div",null,[e[3]||(e[3]=c("",7)),o(n,null,{default:i(()=>e[0]||(e[0]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-switch></l-switch>
