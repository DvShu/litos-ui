...
import{a3 as y,v as E,P as $,x as A,C as B,o as M,c as q,a2 as h,E as l,w as n,j as t,a as d,V as w}from"./chunks/framework.CiKxQFaU.js";import{b as k,i as m,o as u,a as x,$ as P}from"./chunks/browser.Chubywy5.js";const S=JSON.parse('{"title":"Modal 对话框","description":"","frontmatter":{},"headers":[],"relativePath":"components/modal.md","filePath":"components/modal.md","lastUpdated":1787672332000}'),T={name:"components/modal.md"},I=Object.assign(T,{async setup(_){let c,b,i;i=([c,b]=y(()=>w(()=>import("./chunks/modal_box.B7x5bMS5.js"),__vite__mapDeps([0,1,2,3,4,5]))),c=await c,b(),c).default;let r,s;function g(o){const a=o.target.id;a==="alert"?i.alert("这是一段内容","标题").then(()=>{console.log("alert close")}):a==="confirm"?i.confirm("确定要保存更改？","提示").then(p=>{console.log(p)}):a==="prompt"?i.prompt("指令","指令密钥",{placeholder:"请输入指令"}).then(p=>{console.log(p)}):P(`l-modal[for="${a}"]`).setAttribute("show","true")}function f(o){o.target.removeAttribute("show")}function v(o){const e=o.target;e.getAttribute("for")==="open3"&&(e.setAttribute("confirm-loading","true"),e.innerHTML="<span>正在提交内容……</span>",setTimeout(()=>{e.innerHTML="<span>对话框内容</span>",e.removeAttribute("confirm-loading"),o.target.removeAttribute("show")},1500))}return E(()=>{$(()=>{r=k("l-button[id]"),s=k("l-modal"),m(r,o=>{u(o,"click",g)}),m(s,o=>{u(o,"cancel",f),u(o,"ok",v)})})}),A(()=>{r&&(m(r,o=>{x(o,"click",g)}),r=void 0),s&&(m(s,o=>{x(o,"cancel",f)}),s=void 0)}),(o,e)=>{const a=B("ClientOnly");return M(),q("div",null,[e[6]||(e[6]=h("",7)),l(a,null,{default:n(()=>[...e[0]||(e[0]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-modal for="open1" header-title="Header" vertical-align="middle">
    <span>这是内容</span>
  </l-modal>
...
`)])],-1)])]),_:1}),e[16]||(e[16]=h("",3)),l(a,null,{default:n(()=>[...e[5]||(e[5]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-button id="alert">alert</l-button>
...
`)])],-1)])]),_:1}),e[17]||(e[17]=h("",15))])}}});export{S as __pageData,I as default};
