import{_ as p,C as h,c as r,o as d,ag as n,G as e,j as a,w as t,a as l}from"./chunks/framework.DaU-16c2.js";const y=JSON.parse('{"title":"Theme 主题切换","description":"","frontmatter":{},"headers":[],"relativePath":"components/theme.md","filePath":"components/theme.md","lastUpdated":1735010203000}'),k={name:"components/theme.md"};function o(c,s,E,m,u,b){const i=h("ClientOnly");return d(),r("div",null,[s[3]||(s[3]=n(`<h1 id="theme-主题切换" tabindex="-1">Theme 主题切换 <a class="header-anchor" href="#theme-主题切换" aria-label="Permalink to &quot;Theme 主题切换&quot;">​</a></h1><p>通过切换主题来减轻长时间使用屏幕带来的视觉疲劳</p><h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
...
`)],-1)])),_:1,__:[0]}),s[4]||(s[4]=n(`<blockquote><p>切换主题后，如果要让应用启动的时候也应用上一次切换的主题, 需要在应用开始的地方调用 <code>initTheme()</code> 函数</p></blockquote><div class="language-javascript vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// main.js</span></span>
...
`)])],-1)])),_:1,__:[1]}),s[5]||(s[5]=a("h3",{id:"主题色更改",tabindex:"-1"},[l("主题色更改 "),a("a",{class:"header-anchor",href:"#主题色更改","aria-label":'Permalink to "主题色更改"'},"​")],-1)),s[6]||(s[6]=a("p",null,[l("除了修改主题风格，还可以修改主题色，通过修改 "),a("code",null,"ThemeColor"),l(" 来实现。")],-1)),e(i,null,{default:t(()=>s[2]||(s[2]=[a("l-code-preview",null,[a("textarea",{lang:"html"},`  <l-theme-color></l-theme-color>
`)],-1)])),_:1,__:[2]}),s[7]||(s[7]=n(`<p>生成的主题色代码如下:</p><div class="language-CSS vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">CSS</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">:root</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> {</span></span>
