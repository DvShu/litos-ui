import{T as r}from"./chunks/index.DDYqnr9p.js";import{d as h,v as k,P as d,x as b,C as o,o as E,c as m,ag as t,E as l,w as e,j as a,a as i}from"./chunks/framework.C43vV33z.js";import"./chunks/dom.C80Rjh4g.js";const _=JSON.parse('{"title":"Tabs 标签页","description":"","frontmatter":{},"headers":[],"relativePath":"components/tabs.md","filePath":"components/tabs.md","lastUpdated":1753941375000}'),u={name:"components/tabs.md"},f=h({...u,setup(c){let p;return k(()=>{d(()=>{p=r.init()})}),b(()=>{p.destroy()}),(g,s)=>{const n=o("ClientOnly");return E(),m("div",null,[s[3]||(s[3]=t(`<h1 id="tabs-标签页" tabindex="-1">Tabs 标签页 <a class="header-anchor" href="#tabs-标签页" aria-label="Permalink to &quot;Tabs 标签页&quot;">​</a></h1><p>选项卡切换组件；其实这个模块的内容就是 <a href="/litos-ui/components/tabbar">Tabbar 标签栏</a> + 内容区域；所以就没有单独抽取为组件，转而函数 + <code>html</code> 模板的形式。</p><h2 id="引入" tabindex="-1">引入 <a class="header-anchor" href="#引入" aria-label="Permalink to &quot;引入&quot;">​</a></h2><h3 id="手动引入" tabindex="-1">手动引入 <a class="header-anchor" href="#手动引入" aria-label="Permalink to &quot;手动引入&quot;">​</a></h3><p>如果没有使用 <code>litosui-unplugin-resolver</code> 自动引入, 则需要手动引入</p><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Tabs </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">as</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> LTabs } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;litos-io&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
