import{P as d,c as F,p as q}from"./chunks/popover.UecK2Y93.js";import{t as P}from"./chunks/browser.9X2T-Mhz.js";import{v as A,P as C,x as _,C as x,o as w,c as D,a2 as l,E as i,w as r,j as e,a}from"./chunks/framework.0mmZ3Di7.js";const M=JSON.parse('{"title":"Popover 弹出气泡","description":"","frontmatter":{},"headers":[],"relativePath":"components/popover.md","filePath":"components/popover.md","lastUpdated":1787245584000}'),B={name:"components/popover.md"},R=Object.assign(B,{setup($){let h,u,v,k,g,m,b,E,p,s,f,c;function y(){if(s){let o=document.createElement("l-tag");o.setAttribute("closable","true"),o.setAttribute("type","primary"),o.setAttribute("data-title","标签提示"),o.style.marginRight="5px",o.classList.add("tooltip-tag"),o.innerHTML="标签",s.appendChild(o),P(o,"l-scale","enter"),o=null}}function T(o){P(o.target,"l-scale","leave",()=>{o.target.remove()})}return A(()=>{C(()=>{c=new d({theme:"tooltip",reference:".tooltip-tag"}),s=document.getElementById("tagGroup"),s&&(s.addEventListener("close",T),f=F(s,"tooltip-tag",c)),p=document.getElementById("addTag"),p&&p.addEventListener("click",y),h=new d,u=new d({reference:"#hover-popover",trigger:"hover"}),v=new d({reference:"#click-popover",trigger:"click"}),k=new d({reference:"#focus-popover",trigger:"focus"}),g=new d({reference:"#none-arrow",arrow:!1,offset:5}),m=new d({reference:"#custom",contentRender(){const o=document.createDocumentFragment(),t=document.createElement("p");t.innerHTML="自定义内容1",o.appendChild(t);const n=document.createElement("p");return n.innerHTML="自定义内容2",o.appendChild(n),o},updateContent(o,t){}}),b=new d({reference:"#tooltip",theme:"tooltip"}),E=new d({...q,reference:"#popconfirm",onPopoverAction(o){console.log(o)}})})}),_(()=>{s&&s.removeEventListener("close",T),f&&(f.disconnect(),f=void 0),c&&(c.destroy(),c=void 0),p&&p.removeEventListener("click",y),h&&h.destroy(),h=void 0,u&&u.destroy(),u=void 0,v&&v.destroy(),v=void 0,k&&k.destroy(),k=void 0,g&&g.destroy(),g=void 0,m&&m.destroy(),m=void 0,b&&b.destroy(),b=void 0,E&&E.destroy(),E=void 0}),(o,t)=>{const n=x("ClientOnly");return w(),D("div",null,[t[8]||(t[8]=l(`<h1 id="popover-弹出气泡" tabindex="-1">Popover 弹出气泡 <a class="header-anchor" href="#popover-弹出气泡" aria-label="Permalink to &quot;Popover 弹出气泡&quot;">​</a></h1><p>点击/鼠标移入元素，弹出气泡式的卡片浮层。在内容周围弹出一些隐藏的信息。和 <code>Tooltip</code> 的区别是，用户可以对浮层上的元素进行操作，因此它可以承载更复杂的内容，比如链接或按钮等。</p><h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Popover, regist, Button, WarnIcon } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;litos-ui&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
`)])],-1)])]),_:1}),t[9]||(t[9]=l('<blockquote><p>构造 <code>Popver</code> 对象时支持传递 <code>reference</code> 参数，用于指定弹出层的参考元素，如果不指定则查找所有的 <code>.l-popover-reference</code> 元素。</p></blockquote><h3 id="触发方式" tabindex="-1">触发方式 <a class="header-anchor" href="#触发方式" aria-label="Permalink to &quot;触发方式&quot;">​</a></h3><p>三种触发方式：鼠标移入[<code>hover</code>]、点击[<code>click</code>]、焦点[<code>focus</code>]；通过 <code>trigger</code> 属性设置触发方式。默认为：<code>hover</code>；</p>',3)),i(n,null,{default:r(()=>[...t[1]||(t[1]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-button id="hover-popover" data-title="悬浮提示">悬浮提示</l-button>
...
`)],-1)])]),_:1}),t[11]||(t[11]=l('<blockquote><p>也可以再构造 <code>Popover</code> 对象时传递 <code>placement</code> 参数来设置弹出位置。</p></blockquote><h3 id="不显示箭头" tabindex="-1">不显示箭头 <a class="header-anchor" href="#不显示箭头" aria-label="Permalink to &quot;不显示箭头&quot;">​</a></h3><p>构造 <code>Popover</code> 时将 <code>arrow</code> 参数设置为 <code>false</code> 即可；同时可以设置 <code>offset</code> 参数来设置偏移量。</p>',3)),i(n,null,{default:r(()=>[...t[3]||(t[3]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-button id="none-arrow" data-title="提示内容">提示</l-button>
...
`)])],-1)])]),_:1}),t[12]||(t[12]=e("h3",{id:"自定义内容",tabindex:"-1"},[a("自定义内容 "),e("a",{class:"header-anchor",href:"#自定义内容","aria-label":'Permalink to "自定义内容"'},"​")],-1)),t[13]||(t[13]=e("p",null,[a("通过 "),e("code",null,"slot"),a(" 插槽来设置 "),e("code",null,"l-popover"),a(" 的内容")],-1)),i(n,null,{default:r(()=>[...t[4]||(t[4]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-button id="custom">提示</l-button>
...
`)])],-1)])]),_:1}),t[14]||(t[14]=l(`<blockquote><p>出了通过这种形式外，也可以自己通过 <code>popover</code> 属性，指向一个 <code>popover</code> 节点，这个时候，可以完全自定义包括整个 <code>popover</code> 在内的结构</p></blockquote><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-Pqh7s" id="tab-10Du5xO" checked><label data-title="html" for="tab-10Du5xO">html</label><input type="radio" name="group-Pqh7s" id="tab-rXohqEz"><label data-title="js" for="tab-rXohqEz">js</label></div><div class="blocks"><div class="language-html vp-adaptive-theme active line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">div</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> id</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;popover&quot;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> class</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;l-popover&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
