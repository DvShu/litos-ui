...
`),e("textarea",{lang:"js"},`  import { $one, on, off } from 'ph-utils/browser';
...
`)])],-1)])]),_:1}),t[4]||(t[4]=s('<blockquote><p>注意: 设置 <code>l-transition-method=&quot;remove&quot;</code> 后，新添加节点时，需要手动调用 <code>trans.add()</code> 方法重新添加节点动画</p></blockquote><h3 id="手动动画" tabindex="-1">手动动画 <a class="header-anchor" href="#手动动画" aria-label="Permalink to &quot;手动动画&quot;">​</a></h3><p>如果想要手动控制动画，可以通过直接引用 <code>ph-utils/browser transition</code> 然后调用 <code>transition</code> 方法即可。</p>',3)),c(i,null,{default:p(()=>[...t[1]||(t[1]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-button id="toggle2">Toggle</l-button>
  <p id="text2">hello</p>
...
`)])],-1)])]),_:1}),t[5]||(t[5]=s('<blockquote><p><code>transition()</code> 函数有4个参数</p><ol><li><code>el: HTMLElement</code> 执行过渡的节点</li><li><code>property: string | [string, string, string][]</code> 过渡的属性，当为 <code>string</code> 时为过渡名称，通过 <code>css</code> 定义过渡; 为数组时为过渡的属性名，过渡的属性值，过渡的持续时间，如 <code>[&#39;opacity&#39;, &#39;0&#39;, &#39;0.3s&#39;]</code> 为透明度从 <code>1</code> 到 <code>0</code> 的过渡，持续时间为 <code>0.3s</code></li><li><code>dir: &#39;enter&#39; | &#39;leave&#39;</code> 过渡的方向，<code>enter</code> 为进入，<code>leave</code> 为离开</li><li><code>finish?:() =&gt; void</code> 过渡完成后的回调函数</li></ol></blockquote><h3 id="内置过渡" tabindex="-1">内置过渡 <a class="header-anchor" href="#内置过渡" aria-label="Permalink to &quot;内置过渡&quot;">​</a></h3><p>在使用 <code>transition</code> 函数进行过渡时，可以通过引入内置的过渡文件 <code>litos-ui/styles/transition.css</code>，然后就可以通过名称的方式来应用过渡动画。</p>',3)),c(i,null,{default:p(()=>[...t[2]||(t[2]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-button id="toggle3">Toggle</l-button>
