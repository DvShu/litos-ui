import{$ as b,o as p,a as m}from"./chunks/browser.9X2T-Mhz.js";import{v as C,P as D,x as T,C as _,o as E,c as q,a2 as y,E as s,w as c,j as a,a as d}from"./chunks/framework.0mmZ3Di7.js";const R=JSON.parse('{"title":"Calendar 日历","description":"","frontmatter":{},"headers":[],"relativePath":"components/calendar.md","filePath":"components/calendar.md","lastUpdated":1787245584000}'),P={name:"components/calendar.md"},j=Object.assign(P,{setup(S){let o,i,r,h=[],u=!1,l=[];function f(n){const e=n.detail;if(!e.isActiveMonth){const t=e.day.split("-");o.setAttribute("year",t[0]),o.setAttribute("month",Number(t[1]))}}function g(n){const e=n.detail;let t=h.indexOf(e.day);t!==-1?h.splice(t,1):h.push(e.day),i.value=h.join("&")}function k(n){if(l[1]=n,l[0]>l[1]){const e=l[0];l[0]=l[1],l[1]=e}}function v(n){const e=n.detail;u?(k(e.dayTimestamp),u=!1):(u=!0,l=[e.dayTimestamp,e.dayTimestamp]),r.value=l.join(",")}function x(n){if(!u)return;const e=n.detail;k(e.dayTimestamp),r.value=l.join(",")}return C(()=>{D(()=>{o=b("#calendar1"),i=b("#calendar2"),r=b("#calendar3"),o&&p(o,"day-click",f),i&&p(i,"day-click",g),r&&(p(r,"day-click",v),p(r,"day-hover",x))})}),T(()=>{o&&m(o,"day-click",f),i&&m(i,"day-click",g),r&&(m(r,"day-click",v),m(r,"day-hover",x))}),(n,e)=>{const t=_("ClientOnly");return E(),q("div",null,[e[5]||(e[5]=y(`<h1 id="calendar-日历" tabindex="-1">Calendar 日历 <a class="header-anchor" href="#calendar-日历" aria-label="Permalink to &quot;Calendar 日历&quot;">​</a></h1><p>显示日期；按照日历的形式展示数据的容器</p><h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { regist, Calendar } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;litos-ui&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
