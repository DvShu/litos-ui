import{P as s,c as C,p as A}from"./chunks/popover.DwPyAgFX.js";import{t as P}from"./chunks/dom.C80Rjh4g.js";import{v as F,P as _,x,C as q,o as w,c as B,ag as r,E as d,w as l,j as e,a}from"./chunks/framework.CwRcgf5g.js";const V=JSON.parse('{"title":"Popover 弹出气泡","description":"","frontmatter":{},"headers":[],"relativePath":"components/popover.md","filePath":"components/popover.md","lastUpdated":1754560800000}'),D={name:"components/popover.md"},R=Object.assign(D,{setup($){let h,u,k,v,g,m,b,E,p,i,f,c;function y(){if(i){let o=document.createElement("l-tag");o.setAttribute("closable","true"),o.setAttribute("type","primary"),o.setAttribute("data-title","标签提示"),o.style.marginRight="5px",o.classList.add("tooltip-tag"),o.innerHTML="标签",i.appendChild(o),P(o,"l-scale","enter"),o=null}}function T(o){P(o.target,"l-scale","leave",()=>{o.target.remove()})}return F(()=>{_(()=>{c=new s({theme:"tooltip",reference:".tooltip-tag"}),i=document.getElementById("tagGroup"),i&&(i.addEventListener("close",T),f=C(i,"tooltip-tag",c)),p=document.getElementById("addTag"),p&&p.addEventListener("click",y),h=new s,u=new s({reference:"#hover-popover",trigger:"hover"}),k=new s({reference:"#click-popover",trigger:"click"}),v=new s({reference:"#focus-popover",trigger:"focus"}),g=new s({reference:"#none-arrow",arrow:!1,offset:5}),m=new s({reference:"#custom",contentRender(){const o=document.createDocumentFragment(),t=document.createElement("p");t.innerHTML="自定义内容1",o.appendChild(t);const n=document.createElement("p");return n.innerHTML="自定义内容2",o.appendChild(n),o},updateContent(o,t){}}),b=new s({reference:"#tooltip",theme:"tooltip"}),E=new s({...A,reference:"#popconfirm",onPopoverAction(o){console.log(o)}})})}),x(()=>{i&&i.removeEventListener("close",T),f&&(f.disconnect(),f=void 0),c&&(c.destroy(),c=void 0),p&&p.removeEventListener("click",y),h&&h.destroy(),h=void 0,u&&u.destroy(),u=void 0,k&&k.destroy(),k=void 0,v&&v.destroy(),v=void 0,g&&g.destroy(),g=void 0,m&&m.destroy(),m=void 0,b&&b.destroy(),b=void 0,E&&E.destroy(),E=void 0}),(o,t)=>{const n=q("ClientOnly");return w(),B("div",null,[t[8]||(t[8]=r(`<h1 id="popover-弹出气泡" tabindex="-1">Popover 弹出气泡 <a class="header-anchor" href="#popover-弹出气泡" aria-label="Permalink to &quot;Popover 弹出气泡&quot;">​</a></h1><p>点击/鼠标移入元素，弹出气泡式的卡片浮层。在内容周围弹出一些隐藏的信息。和 <code>Tooltip</code> 的区别是，用户可以对浮层上的元素进行操作，因此它可以承载更复杂的内容，比如链接或按钮等。</p><h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Popover, regist, Button, WarnIcon } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;litos-ui&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
`)])],-1)])]),_:1}),t[14]||(t[14]=r(`<blockquote><p>出了通过这种形式外，也可以自己通过 <code>popover</code> 属性，指向一个 <code>popover</code> 节点，这个时候，可以完全自定义包括整个 <code>popover</code> 在内的结构</p></blockquote><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-x7N4B" id="tab-9NeZQKB" checked><label data-title="html" for="tab-9NeZQKB">html</label><input type="radio" name="group-x7N4B" id="tab-dyxXlIJ"><label data-title="js" for="tab-dyxXlIJ">js</label></div><div class="blocks"><div class="language-html vp-adaptive-theme active line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">html</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&lt;</span><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">div</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> id</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;popover&quot;</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> class</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">=</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;l-popover&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">&gt;</span></span>
