import{e as m,i as p,o as b}from"./chunks/dom.CBY_V37t.js";import{M as h}from"./chunks/index.B1guJeO_.js";import{v as k,P as f,x as _,C as M,c as y,o as x,ag as n,G as i,j as t,w as r,a as s}from"./chunks/framework.BCyZWppQ.js";import"./chunks/index.BlcR5lE1.js";import"./chunks/index.DZ7iFm8i.js";import"./chunks/info.7dcC2p4v.js";const S=JSON.parse('{"title":"Message 消息提示","description":"","frontmatter":{},"headers":[],"relativePath":"components/message.md","filePath":"components/message.md","lastUpdated":1737345140000}'),q={name:"components/message.md"},O=Object.assign(q,{setup(v){let o,l;function c(a){const e=a.target,d=e.getAttribute("data-message"),u=e.getAttribute("data-type")||"info",g=e.getAttribute("data-duration")||3e3;u!=="close"?l=h.show({message:d,type:u,duration:Number(g)}):h.close(l)}return k(()=>{f(()=>{o=m(".preview-container l-button"),p(o,a=>{b(a,"click",c)})})}),_(()=>{o&&p(o,a=>{a.removeEventListener("click",c)})}),(a,e)=>{const d=M("ClientOnly");return x(),y("div",null,[e[3]||(e[3]=n("",7)),i(d,null,{default:r(()=>e[0]||(e[0]=[t("l-code-preview",null,[t("textarea",null,`<l-button data-message="这是一条普通的提示信息">显示消息</l-button>
...
`),t("div",{class:"source"},[t("textarea",{lang:"js"},`  import { Message } from 'litos-ui';
  ...
  // 关闭消息
  Message.close(id);
`)])],-1)])),_:1}),e[7]||(e[7]=n("",5))])}}});export{S as __pageData,O as default};
