import{_ as i,C as s,o as d,c as o,ag as t,E as l,w as r,j as n}from"./chunks/framework.CwRcgf5g.js";const f=JSON.parse('{"title":"Menu 菜单","description":"","frontmatter":{},"headers":[],"relativePath":"components/menu.md","filePath":"components/menu.md","lastUpdated":1751903374000}'),h={name:"components/menu.md"};function u(c,e,m,b,p,k){const a=s("ClientOnly");return d(),o("div",null,[e[1]||(e[1]=t("",7)),l(a,null,{default:r(()=>[...e[0]||(e[0]=[n("l-code-preview",null,[n("textarea",{lang:"html"},`  <l-menu id="menu" selected-index="A1">
    <l-sub-menu index="N1">
...
`)],-1)])]),_:1}),e[2]||(e[2]=t("",11))])}const y=i(h,[["render",u]]);export{f as __pageData,y as default};
