import{T as r}from"./chunks/index.DDYqnr9p.js";import{d as h,v as k,P as d,x as b,C as o,o as E,c as m,ag as t,E as l,w as e,j as a,a as i}from"./chunks/framework.C43vV33z.js";import"./chunks/dom.C80Rjh4g.js";const _=JSON.parse('{"title":"Tabs 标签页","description":"","frontmatter":{},"headers":[],"relativePath":"components/tabs.md","filePath":"components/tabs.md","lastUpdated":1753941375000}'),u={name:"components/tabs.md"},f=h({...u,setup(c){let p;return k(()=>{d(()=>{p=r.init()})}),b(()=>{p.destroy()}),(g,s)=>{const n=o("ClientOnly");return E(),m("div",null,[s[3]||(s[3]=t("",9)),l(n,null,{default:e(()=>[...s[0]||(s[0]=[a("l-code-preview",null,[a("textarea",{lang:"html"},`  <div class="l-tabs">
