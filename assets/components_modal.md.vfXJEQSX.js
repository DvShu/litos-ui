import{c as A,o as h,$ as w,b as E,i as b,a as M}from"./chunks/dom.C80Rjh4g.js";import{B as k,M as x,C as v,F as C,I as q}from"./chunks/index.BMIZV4-3.js";import{r as y,I as B}from"./chunks/info.NbEmhnBZ.js";import{v as P,P as T,x as L,C as S,o as I,c as _,ag as f,E as p,w as m,j as t,a as o}from"./chunks/framework.C43vV33z.js";import"./chunks/color.DEra9DJZ.js";import"./chunks/index.EbPK5eBu.js";function $(c,l,a,r="alert"){return new Promise(i=>{const s=[];if(a.icon){let e=a.icon();e.setAttribute("slot","header"),s.push(e.outerHTML)}s.push(`<span slot="header">${c}</span>`),r==="prompt"?(s.push(`<l-form-item label="${l}" label-position="top" inner-block>`),s.push(`<l-input placeholder="${a.placeholder||""}"></l-input>`),s.push("</l-form-item>")):s.push(`<span>${l}</span>`);let d=A("l-modal",{cancel:`${a.showCancel}`,innerHTML:s.join(""),show:!0,class:`l-modal-box l-modal-box--${r}`,close:`${a.close}`,"mask-closable":`${a.maskClosable}`});h(d,"close",()=>{d.remove(),d=void 0},{once:!0}),h(d,"ok",()=>{let e=!0;r==="prompt"&&(e=w(".l-modal-box l-input").value),d.removeAttribute("show"),i(e)},{once:!0}),h(d,"cancel",()=>{d.removeAttribute("show"),i(!1)},{once:!0}),document.body.appendChild(d)})}function F(c,l,a){return y([k,x,v]),new Promise(r=>{const i={showCancel:!1,close:0,maskClosable:!1,icon:void 0,...a};return $(l||"提示",c,i,"alert")})}function V(c,l,a){y([k,x,v,B]);const r={showCancel:!0,close:0,maskClosable:!0,icon:()=>A("l-info-icon",{style:"color:#1890ff;"}),...a};return $(l||"提示",c,r,"confirm")}function j(c,l,a){y([k,x,v,B,C,q]);const r={showCancel:!0,close:0,maskClosable:!0,placeholder:"",...a};return $(l||"提示",c,r,"prompt")}const g={alert:F,confirm:V,prompt:j},J=JSON.parse('{"title":"Modal 对话框","description":"","frontmatter":{},"headers":[],"relativePath":"components/modal.md","filePath":"components/modal.md","lastUpdated":1776163896000}'),D={name:"components/modal.md"},G=Object.assign(D,{setup(c){let l,a;function r(d){const n=d.target.id;n==="alert"?g.alert("这是一段内容","标题").then(()=>{console.log("alert close")}):n==="confirm"?g.confirm("确定要保存更改？","提示").then(u=>{console.log(u)}):n==="prompt"?g.prompt("指令","指令密钥",{placeholder:"请输入指令"}).then(u=>{console.log(u)}):w(`l-modal[for="${n}"]`).setAttribute("show","true")}function i(d){d.target.removeAttribute("show")}function s(d){const e=d.target;e.getAttribute("for")==="open3"&&(e.setAttribute("confirm-loading","true"),e.innerHTML="<span>正在提交内容……</span>",setTimeout(()=>{e.innerHTML="<span>对话框内容</span>",e.removeAttribute("confirm-loading"),d.target.removeAttribute("show")},1500))}return P(()=>{T(()=>{l=E("l-button[id]"),a=E("l-modal"),b(l,d=>{h(d,"click",r)}),b(a,d=>{h(d,"cancel",i),h(d,"ok",s)})})}),L(()=>{l&&(b(l,d=>{M(d,"click",r)}),l=void 0),a&&(b(a,d=>{M(d,"cancel",i)}),a=void 0)}),(d,e)=>{const n=S("ClientOnly");return I(),_("div",null,[e[6]||(e[6]=f(`<h1 id="modal-对话框" tabindex="-1">Modal 对话框 <a class="header-anchor" href="#modal-对话框" aria-label="Permalink to &quot;Modal 对话框&quot;">​</a></h1><p>在保留当前页面状态的情况下，弹出一个对话框告知用户并承载相关操作，包含：标题区、内容区、操作区</p><h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Modal, regist, Button, CloseIcon } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;litos-ui&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
`)])],-1)])]),_:1}),e[7]||(e[7]=t("h3",{id:"自定义头部",tabindex:"-1"},[o("自定义头部 "),t("a",{class:"header-anchor",href:"#自定义头部","aria-label":'Permalink to "自定义头部"'},"​")],-1)),e[8]||(e[8]=t("p",null,[o("除了使用 "),t("code",null,"header"),o(" 属性定义头部内容外，也可以通过传递 "),t("code",null,"header-slot"),o(" 插槽自定义头部内容。通过传递 "),t("code",null,"width"),o(" 属性改变宽度")],-1)),p(n,null,{default:m(()=>[...e[1]||(e[1]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-modal for="open2" width="300px">
...
`)])],-1)])]),_:1}),e[9]||(e[9]=t("blockquote",null,[t("p",null,[o("注意：实际使用 "),t("code",null,"l-info-icon"),o(" 时, 需要 "),t("code",null,"regist"),o(" 注册")])],-1)),e[10]||(e[10]=t("h3",{id:"异步关闭",tabindex:"-1"},[o("异步关闭 "),t("a",{class:"header-anchor",href:"#异步关闭","aria-label":'Permalink to "异步关闭"'},"​")],-1)),e[11]||(e[11]=t("p",null,"点击确定后异步关闭对话框，例如提交表单。",-1)),p(n,null,{default:m(()=>[...e[2]||(e[2]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-modal for="open3" header-title="异步关闭">
    <span>对话框内容</span>
  </l-modal>
...
`)])],-1)])]),_:1}),e[12]||(e[12]=t("h3",{id:"关闭按钮",tabindex:"-1"},[o("关闭按钮 "),t("a",{class:"header-anchor",href:"#关闭按钮","aria-label":'Permalink to "关闭按钮"'},"​")],-1)),e[13]||(e[13]=t("p",null,[o("通过设置 "),t("code",null,"close"),o(" 来控制关闭按钮的显示以及位置；"),t("code",null,"0"),o(" - 不显示, "),t("code",null,"1"),o(" - 显示在框内(默认), "),t("code",null,"2"),o(" - 显示在边角")],-1)),p(n,null,{default:m(()=>[...e[3]||(e[3]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-modal for="open4" header-title="Title" close="2">
    <span>对话框内容</span>
  </l-modal>
...
`)])],-1)])]),_:1}),e[14]||(e[14]=t("h3",{id:"移动风格",tabindex:"-1"},[o("移动风格 "),t("a",{class:"header-anchor",href:"#移动风格","aria-label":'Permalink to "移动风格"'},"​")],-1)),e[15]||(e[15]=t("p",null,[o("默认情况下对话框为 "),t("code",null,"pc"),o(" 端风格，可以通过传递 "),t("code",null,"mobile"),o(" 属性将对话框变为移动风格；设置 "),t("code",null,'vertical-align="middle"'),o(" 让对话框垂直居中显示;具体表现为：文本居中，下方按钮平铺")],-1)),p(n,null,{default:m(()=>[...e[4]||(e[4]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-modal for="open5" header-title="Title" mobile close="0" vertical-align="middle">
    <span>这是内容</span>
  </l-modal>
