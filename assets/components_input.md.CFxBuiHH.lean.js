import{$ as p}from"./chunks/dom.DBNJew1L.js";import{v as u,P as h,C as c,c as b,o as m,ag as r,G as l,j as e,w as n,a}from"./chunks/framework._HD6XqYi.js";const v=JSON.parse('{"title":"Input 输入框","description":"","frontmatter":{},"headers":[],"relativePath":"components/input.md","filePath":"components/input.md","lastUpdated":1756372474000}'),f={name:"components/input.md"},P=Object.assign(f,{setup(g){let i;function s(o){let t=parseInt(o,10);return Number.isNaN(t)?t="":t=Math.abs(t),String(t)}return u(()=>{h(()=>{i=p("#input"),i.addEventListener("change",function(o){console.log("input",o.target.value)}),i.setParser(s)})}),(o,t)=>{const d=c("ClientOnly");return m(),b("div",null,[t[6]||(t[6]=r("",6)),l(d,null,{default:n(()=>[...t[0]||(t[0]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-input placeholder="请输入内容"></l-input>
...
`)],-1)])]),_:1}),t[9]||(t[9]=r("",2)),l(d,null,{default:n(()=>[...t[2]||(t[2]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-input placeholder="只能输入正整数" allow-input="integer"></l-input>
...
`)],-1)])]),_:1}),t[16]||(t[16]=r("",9))])}}});export{v as __pageData,P as default};
