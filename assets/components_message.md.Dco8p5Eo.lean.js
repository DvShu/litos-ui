import{e as m,i as p,o as b}from"./chunks/dom.DntxtiBs.js";import{M as h}from"./chunks/index.TF7csJTw.js";import{v as k,P as f,x as _,C as y,o as M,c as x,ag as n,E as i,w as r,j as t,a as s}from"./chunks/framework.-4c4jpF6.js";import"./chunks/info.DAzEmGVU.js";import"./chunks/index.DZ7iFm8i.js";const C=JSON.parse('{"title":"Message 消息提示","description":"","frontmatter":{},"headers":[],"relativePath":"components/message.md","filePath":"components/message.md","lastUpdated":1768457228000}'),q={name:"components/message.md"},S=Object.assign(q,{setup(v){let o,l;function c(a){const e=a.target,d=e.getAttribute("data-message"),u=e.getAttribute("data-type")||"info",g=e.getAttribute("data-duration")||3e3;u!=="close"?l=h.show({message:d,type:u,duration:Number(g)}):h.close(l)}return k(()=>{f(()=>{o=m(".preview-container l-button"),p(o,a=>{b(a,"click",c)})})}),_(()=>{o&&p(o,a=>{a.removeEventListener("click",c)})}),(a,e)=>{const d=y("ClientOnly");return M(),x("div",null,[e[3]||(e[3]=n("",7)),i(d,null,{default:r(()=>[...e[0]||(e[0]=[t("l-code-preview",null,[t("textarea",null,`<l-button data-message="这是一条普通的提示信息">显示消息</l-button>
