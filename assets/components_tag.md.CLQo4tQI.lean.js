import{t as c}from"./chunks/browser.Chubywy5.js";import{v as g,P as b,C as u,o as k,c as m,a2 as l,E as i,w as o,j as a,a as s}from"./chunks/framework.CiKxQFaU.js";const v=JSON.parse('{"title":"Tag 标签","description":"","frontmatter":{},"headers":[],"relativePath":"components/tag.md","filePath":"components/tag.md","lastUpdated":1787245584000}'),y={name:"components/tag.md"},C=Object.assign(y,{setup(E){let r,n;function h(){if(n){let e=document.createElement("l-tag");e.setAttribute("closable","true"),e.setAttribute("type","primary"),e.style.marginRight="5px",e.innerHTML="标签",n.appendChild(e),c(e,"l-scale","enter"),e=null}}function p(e){c(e.target,"l-scale","leave",()=>{e.target.remove()})}return g(()=>{b(()=>{r=document.getElementById("btn-add"),n=document.getElementById("tag-container"),n.addEventListener("close",p),r.addEventListener("click",h)})}),(e,t)=>{const d=u("ClientOnly");return k(),m("div",null,[t[3]||(t[3]=l("",7)),i(d,null,{default:o(()=>[...t[0]||(t[0]=[a("l-code-preview",null,[a("textarea",{lang:"html"},`  <l-tag type="primary">标签</l-tag>
...
`),a("div",{class:"source"},[a("textarea",{lang:"html"},`  <l-button id="btn-add">添加</l-button>
  <hr />
  <div id="tag-container"></div>
`),a("textarea",{lang:"js"},`  import { transition } from 'ph-utils/browser';
  //-
