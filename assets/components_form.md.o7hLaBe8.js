import{$ as n,o as c,a as h}from"./chunks/dom.DwYf1ZNH.js";import{v as p,P as b,x as u,c as f,a2 as i,G as l,w as r,j as e,a as d,B as k,o as y}from"./chunks/framework.Dxibp1RX.js";const F=JSON.parse('{"title":"Form","description":"","frontmatter":{},"headers":[],"relativePath":"components/form.md","filePath":"components/form.md","lastUpdated":1737345140000}'),v={name:"components/form.md"},P=Object.assign(v,{setup(g){function s(a){const t=a.target.value;n("#positionForm").setAttribute("label-position",t)}return p(()=>{b(()=>{{n("#lform").addEventListener("submit",o=>{const m=o.target;console.log(m.getData())});const t=n("#positionRadio");h(t,"change",s)}})}),u(()=>{{const a=n("#positionRadio");a&&c(a,"change",s)}}),(a,t)=>{const o=k("ClientOnly");return y(),f("div",null,[t[5]||(t[5]=i(`<h1 id="form" tabindex="-1">Form <a class="header-anchor" href="#form" aria-label="Permalink to &quot;Form&quot;">​</a></h1><p>Form</p><h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Form, regist } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;litos-ui&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">regist</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(Form);</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div><h2 id="演示" tabindex="-1">演示 <a class="header-anchor" href="#演示" aria-label="Permalink to &quot;演示&quot;">​</a></h2><h3 id="基础用法" tabindex="-1">基础用法 <a class="header-anchor" href="#基础用法" aria-label="Permalink to &quot;基础用法&quot;">​</a></h3><p>基本的表单数据域控制展示，包含布局、初始化、验证、提交。数据验证采用 <a href="https://gitee.com/towardly/ph/wikis/utils/validator" target="_blank" rel="noreferrer">ph-utils/validator</a></p>`,7)),l(o,null,{default:r(()=>t[0]||(t[0]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-form id="lform">
...
`)],-1)])),_:1}),t[6]||(t[6]=i('<blockquote><ol><li>如果想要实现按钮之间的间隔，需要引入 <code>litos-ui/styles/reset.css</code> 文件</li><li>当 <code>Button</code> 在 <code>Form</code> 里面时，如果 <code>Button</code> 的 <code>html-type</code> 属性为 <code>reset</code>、<code>submit</code> 时会自动触发表单的重置、提交。</li></ol></blockquote><h3 id="innerblock" tabindex="-1"><code>InnerBlock</code> <a class="header-anchor" href="#innerblock" aria-label="Permalink to &quot;`InnerBlock`&quot;">​</a></h3><p>设置 <code>inner-block</code> 能够让表单的行内元素铺满剩余宽度</p>',3)),l(o,null,{default:r(()=>t[1]||(t[1]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-form inner-block>
    <l-form-item required label="姓名" name="name">
      <l-input placeholder="请输入姓名" value="张三"></l-input>
    </l-form-item>
    <l-form-item required label="密码" name="password">
...
`)],-1)])),_:1}),t[10]||(t[10]=i('<h3 id="对齐方式" tabindex="-1">对齐方式 <a class="header-anchor" href="#对齐方式" aria-label="Permalink to &quot;对齐方式&quot;">​</a></h3><p>通过设置 <code>label-position</code> 来应用标签和内容的对齐方式。</p><p>您可以分别设置 <code>l-form-item</code> 的 <code>label-position</code>. 如果值为空, 则会使用 <code>l-form</code> 的 <code>label-position</code>。</p>',3)),l(o,null,{default:r(()=>t[3]||(t[3]=[e("l-code-preview",null,[e("textarea",{lang:"html"},`  <l-form id="positionForm" inner-block>
