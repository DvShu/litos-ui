const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/modal_box.B7x5bMS5.js","assets/chunks/index.C0toAiR-.js","assets/chunks/info.BgTfn2LJ.js","assets/chunks/browser.Chubywy5.js","assets/chunks/index.B_dLCkhl.js","assets/chunks/index.CuJgq1IQ.js"])))=>i.map(i=>d[i]);
import{a3 as y,v as E,P as $,x as A,C as B,o as M,c as q,a2 as h,E as l,w as n,j as t,a as d,V as w}from"./chunks/framework.CiKxQFaU.js";import{b as k,i as m,o as u,a as x,$ as P}from"./chunks/browser.Chubywy5.js";const S=JSON.parse('{"title":"Modal 对话框","description":"","frontmatter":{},"headers":[],"relativePath":"components/modal.md","filePath":"components/modal.md","lastUpdated":1787672332000}'),T={name:"components/modal.md"},I=Object.assign(T,{async setup(_){let c,b,i;i=([c,b]=y(()=>w(()=>import("./chunks/modal_box.B7x5bMS5.js"),__vite__mapDeps([0,1,2,3,4,5]))),c=await c,b(),c).default;let r,s;function g(o){const a=o.target.id;a==="alert"?i.alert("这是一段内容","标题").then(()=>{console.log("alert close")}):a==="confirm"?i.confirm("确定要保存更改？","提示").then(p=>{console.log(p)}):a==="prompt"?i.prompt("指令","指令密钥",{placeholder:"请输入指令"}).then(p=>{console.log(p)}):P(`l-modal[for="${a}"]`).setAttribute("show","true")}function f(o){o.target.removeAttribute("show")}function v(o){const e=o.target;e.getAttribute("for")==="open3"&&(e.setAttribute("confirm-loading","true"),e.innerHTML="<span>正在提交内容……</span>",setTimeout(()=>{e.innerHTML="<span>对话框内容</span>",e.removeAttribute("confirm-loading"),o.target.removeAttribute("show")},1500))}return E(()=>{$(()=>{r=k("l-button[id]"),s=k("l-modal"),m(r,o=>{u(o,"click",g)}),m(s,o=>{u(o,"cancel",f),u(o,"ok",v)})})}),A(()=>{r&&(m(r,o=>{x(o,"click",g)}),r=void 0),s&&(m(s,o=>{x(o,"cancel",f)}),s=void 0)}),(o,e)=>{const a=B("ClientOnly");return M(),q("div",null,[e[6]||(e[6]=h(`<h1 id="modal-对话框" tabindex="-1">Modal 对话框 <a class="header-anchor" href="#modal-对话框" aria-label="Permalink to &quot;Modal 对话框&quot;">​</a></h1><p>在保留当前页面状态的情况下，弹出一个对话框告知用户并承载相关操作，包含：标题区、内容区、操作区</p><h2 id="引用" tabindex="-1">引用 <a class="header-anchor" href="#引用" aria-label="Permalink to &quot;引用&quot;">​</a></h2><div class="language-js vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">import</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> { Modal, regist, Button, CloseIcon } </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">from</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &quot;litos-ui&quot;</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">;</span></span>
...
`)])],-1)])]),_:1}),e[16]||(e[16]=h('<h3 id="消息弹窗" tabindex="-1">消息弹窗 <a class="header-anchor" href="#消息弹窗" aria-label="Permalink to &quot;消息弹窗&quot;">​</a></h3><p>模拟系统的消息提示框而实现的一套模态对话框组件，用于消息提示、确认消息和提交内容。系统自带有3种消息弹窗：<code>alert</code>、<code>confirm</code>、<code>prompt</code> 但是其样式比较简陋不太美观，消息弹窗优化了样式。</p><p>分别通过 <code>LModalBox.alert()</code>、<code>LModalBox.confirm()</code>、<code>LModalBox.prompt()</code> 调用</p>',3)),l(a,null,{default:n(()=>[...e[5]||(e[5]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-button id="alert">alert</l-button>
