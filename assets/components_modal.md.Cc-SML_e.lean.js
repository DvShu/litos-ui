import{c as A,o as u,$ as B,b as E,i as b,a as M}from"./chunks/dom.BOKvBN-7.js";import{B as k,M as x,C as v,F as q,I as P}from"./chunks/index.2elUEZRk.js";import{I as C}from"./chunks/info.BhPFqlOn.js";import{r as y}from"./chunks/index.DCtgrrjC.js";import{v as T,P as L,x as w,C as S,c as I,o as _,ag as f,G as p,j as t,w as m,a as d}from"./chunks/framework.BCyZWppQ.js";import"./chunks/color.9DIoxwsF.js";import"./chunks/index.DZ7iFm8i.js";function $(i,l,a,r="alert"){return new Promise(c=>{const s=[];if(a.icon){let e=a.icon();e.setAttribute("slot","header"),s.push(e.outerHTML)}s.push(`<span slot="header">${i}</span>`),r==="prompt"?(s.push(`<l-form-item label="${l}" label-position="top" inner-block>`),s.push(`<l-input placeholder="${a.placeholder||""}"></l-input>`),s.push("</l-form-item>")):s.push(`<span>${l}</span>`);let o=A("l-modal",{cancel:`${a.showCancel}`,innerHTML:s.join(""),open:!0,class:`l-modal-box l-modal-box--${r}`,close:`${a.close}`,"mask-closable":`${a.maskClosable}`});u(o,"close",()=>{o.remove(),o=void 0},{once:!0}),u(o,"ok",()=>{let e=!0;r==="prompt"&&(e=B(".l-modal-box l-input").value),o.removeAttribute("open"),c(e)},{once:!0}),u(o,"cancel",()=>{o.removeAttribute("open"),c(!1)},{once:!0}),document.body.appendChild(o)})}function F(i,l,a){return y([k,x,v]),new Promise(r=>{const c={showCancel:!1,close:0,maskClosable:!1,icon:void 0,...a};return $(l||"提示",i,c,"alert")})}function V(i,l,a){y([k,x,v,C]);const r={showCancel:!0,close:0,maskClosable:!0,icon:()=>A("l-info-icon",{style:"color:#1890ff;"}),...a};return $(l||"提示",i,r,"confirm")}function j(i,l,a){y([k,x,v,C,q,P]);const r={showCancel:!0,close:0,maskClosable:!0,placeholder:"",...a};return $(l||"提示",i,r,"prompt")}const g={alert:F,confirm:V,prompt:j},J=JSON.parse('{"title":"Modal 对话框","description":"","frontmatter":{},"headers":[],"relativePath":"components/modal.md","filePath":"components/modal.md","lastUpdated":1743478616000}'),D={name:"components/modal.md"},K=Object.assign(D,{setup(i){let l,a;function r(o){const n=o.target.id;n==="alert"?g.alert("这是一段内容","标题").then(()=>{console.log("alert close")}):n==="confirm"?g.confirm("确定要保存更改？","提示").then(h=>{console.log(h)}):n==="prompt"?g.prompt("指令","指令密钥",{placeholder:"请输入指令"}).then(h=>{console.log(h)}):B(`l-modal[for="${n}"]`).setAttribute("open","true")}function c(o){o.target.removeAttribute("open")}function s(o){const e=o.target;e.getAttribute("for")==="open3"&&(e.setAttribute("confirm-loading","true"),e.innerHTML="<span>正在提交内容……</span>",setTimeout(()=>{e.innerHTML="<span>对话框内容</span>",e.removeAttribute("confirm-loading"),o.target.removeAttribute("open")},1500))}return T(()=>{L(()=>{l=E("l-button[id]"),a=E("l-modal"),b(l,o=>{u(o,"click",r)}),b(a,o=>{u(o,"cancel",c),u(o,"ok",s)})})}),w(()=>{l&&(b(l,o=>{M(o,"click",r)}),l=void 0),a&&(b(a,o=>{M(o,"cancel",c)}),a=void 0)}),(o,e)=>{const n=S("ClientOnly");return _(),I("div",null,[e[6]||(e[6]=f("",7)),p(n,null,{default:m(()=>e[0]||(e[0]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-modal for="open1" title="Title" vertical-align="middle">
    <span>这是内容</span>
  </l-modal>
...
`)])],-1)])),_:1}),e[17]||(e[17]=f("",15))])}}});export{J as __pageData,K as default};
