...
`)],-1)])),_:1,__:[0]}),a[5]||(a[5]=t("h3",{id:"选项卡模式",tabindex:"-1"},[e("选项卡模式 "),t("a",{class:"header-anchor",href:"#选项卡模式","aria-label":'Permalink to "选项卡模式"'},"​")],-1)),a[6]||(a[6]=t("p",null,[e("基础的、简洁的选项卡，设置 "),t("code",null,"type"),e(" 为 "),t("code",null,"bar"),e("。")],-1)),d(r,null,{default:n(()=>a[1]||(a[1]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-tabbar type="bar" name="2">
    <l-tabbar-item name="1">选项1</l-tabbar-item>
    <l-tabbar-item name="2">选项2</l-tabbar-item>
    <l-tabbar-item name="3">选项3</l-tabbar-item>
  </l-tabbar>
`)],-1)])),_:1,__:[1]}),a[7]||(a[7]=t("h3",{id:"卡片式",tabindex:"-1"},[e("卡片式 "),t("a",{class:"header-anchor",href:"#卡片式","aria-label":'Permalink to "卡片式"'},"​")],-1)),a[8]||(a[8]=t("p",null,[e("具有卡片风格的标签。只需要设置 "),t("code",null,"type"),e(" 属性为 "),t("code",null,"card"),e(" 就可以使选项卡改变为标签风格。 同时可以通过 "),t("code",null,"gap"),e(" 调整选项卡之间的间距。")],-1)),d(r,null,{default:n(()=>a[2]||(a[2]=[t("l-code-preview",null,[t("textarea",{lang:"html"},`  <l-tabbar type="card" name="1">
    <l-tabbar-item name="1">选项1</l-tabbar-item>
    <l-tabbar-item name="2">选项2</l-tabbar-item>
    <l-tabbar-item name="3">选项3</l-tabbar-item>
  </l-tabbar>
